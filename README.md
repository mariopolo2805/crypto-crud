...
To run unit test, run next command:
...
To run integration test, run next command:

> `npm run e2e`


This will exec basic layer of e2e testing with cypress.
**Remember:** `backend` server must be up and running!
